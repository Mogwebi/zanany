	...
	<div class="flex-row">
	    ...
	    <div class="form-upload-info">
	        ...
	        <div class="flex-row">
	            <p class="form-upload-genre">
	                ...
	                <?php 
						...
						$tag = apply_filters('play_upload_form_tag', $tag, $post);
						$cat = apply_filters('play_upload_form_cat', $cat, $post);
	            ...
	            <div class="sep"></div>
            	<?php if( apply_filters('play_register_audio_type', true) && in_array($post->type, array('playlist', 'album')) ){ ?>
            ...
            <p class="form-upload-tag">
                ...
                <?php
                	$tags = wp_get_post_terms($post->ID, $tag, array("fields" => "names"));
                	$tags = apply_filters('play_upload_form_tags', $tags, $post);
                ?>
