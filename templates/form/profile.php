        ...
        <div>
            ...
            <div class="profile-form-social-networks">
                ...
                <p class="input-facebook">
                    ...
                    <input type="url" name="facebook" class="input" value="<?php echo esc_attr( get_user_meta( $user->ID, 'facebook', true ) ); ?>" />
                </p>
                <p class="input-twitter">
                    <label><?php play_get_text('twitter', 'true'); ?></label>
                    <input type="url" name="twitter" class="input" placeholder="<?php play_get_text('twitter-username', 'true'); ?>" value="<?php echo esc_attr( get_user_meta( $user->ID, 'twitter', true ) ); ?>" />
                </p>
                <p class="input-tiktok">
                    <label><?php play_get_text('tiktok', 'true'); ?></label>
                    <input type="url" name="tiktok" class="input" value="<?php echo esc_attr( get_user_meta( $user->ID, 'tiktok', true ) ); ?>" />
                </p>
                <p class="input-youtube">
                    <label><?php play_get_text('youtube', 'true'); ?></label>
                    <input type="url" name="youtube" class="input" value="<?php echo esc_attr( get_user_meta( $user->ID, 'youtube', true ) ); ?>" />
                </p>
                <p class="input-instagram">
                    <label><?php play_get_text('instagram', 'true'); ?></label>
                    <input type="url" name="instagram" class="input" value="<?php echo esc_attr( get_user_meta( $user->ID, 'instagram', true ) ); ?>" />
                </p>
                <p class="input-whatsapp">
                    <label><?php play_get_text('whatsapp', 'true'); ?></label>
                    <input type="url" name="whatsapp" class="input" value="<?php echo esc_attr( get_user_meta( $user->ID, 'whatsapp', true ) ); ?>" />
                </p>
                <p class="input-snapchat">
                    <label><?php play_get_text('snapchat', 'true'); ?></label>
                    <input type="url" name="snapchat" class="input" value="<?php echo esc_attr( get_user_meta( $user->ID, 'snapchat', true ) ); ?>" />
                </p>
				
			<p class="input-coffee">
                    <label><?php play_get_text('Buy me a coffee', 'true'); ?></label>
                    <input type="url" name="coffee" class="input" value="<?php echo esc_attr( get_user_meta( $user->ID, 'coffee', true ) ); ?>" />
                </p>	
