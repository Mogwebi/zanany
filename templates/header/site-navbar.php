...
<div class="header-container">
	<div class="site-navbar">
		...
		<form class="search-form" method="get" action="<?php echo esc_url(home_url()); ?>">
			<input type="search" placeholder="<?php esc_attr_e('search song,artist,album...','waveme'); ?>" value="" name="s" data-toggle="dropdown" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false">
